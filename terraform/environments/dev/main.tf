...
resource "aws_eks_cluster" "main" {
  #checkov:skip=CKV_AWS_39:EKS public endpoint is intentionally enabled for local operator access in this portfolio environment; access is restricted to admin_cidr_blocks instead of 0.0.0.0/0.
...
resource "aws_iam_policy" "github_actions_deploy" {
  ...
  description = "Least-privilege deployment policy for GitHub Actions."
